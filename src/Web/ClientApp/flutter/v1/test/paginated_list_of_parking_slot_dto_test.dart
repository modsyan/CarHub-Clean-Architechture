...
// tests for PaginatedListOfParkingSlotDto
void main() {
  // final instance = PaginatedListOfParkingSlotDto();

  group('test PaginatedListOfParkingSlotDto', () {
    // List<ParkingSlotDto> items (default value: const [])
