...
// tests for PaginatedListOfCarBriefDto
void main() {
  // final instance = PaginatedListOfCarBriefDto();

  group('test PaginatedListOfCarBriefDto', () {
    // List<CarBriefDto> items (default value: const [])
