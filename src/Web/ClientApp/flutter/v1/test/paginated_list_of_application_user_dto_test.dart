...
// tests for PaginatedListOfApplicationUserDto
void main() {
  // final instance = PaginatedListOfApplicationUserDto();

  group('test PaginatedListOfApplicationUserDto', () {
    // List<ApplicationUserDto> items (default value: const [])
