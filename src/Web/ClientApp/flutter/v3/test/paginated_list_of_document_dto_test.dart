...
// tests for PaginatedListOfDocumentDto
void main() {
  // final instance = PaginatedListOfDocumentDto();

  group('test PaginatedListOfDocumentDto', () {
    // List<DocumentDto> items (default value: const [])
