...
// tests for PaginatedListOfInspectionDto
void main() {
  // final instance = PaginatedListOfInspectionDto();

  group('test PaginatedListOfInspectionDto', () {
    // List<InspectionDto> items (default value: const [])
